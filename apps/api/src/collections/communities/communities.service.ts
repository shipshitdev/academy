...
export class CommunitiesService {
  ...
  async findPublished(): Promise<Community[]> {
    return this.communityModel.find({ isPublished: true }).sort({ sortOrder: 1, title: 1 });
  }
  ...
  private normalizePayload(payload: CreateCommunityDto | UpdateCommunityDto, userId?: string) {
